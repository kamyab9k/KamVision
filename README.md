...
#### :dart: Download the demonstration of the library usage in a sample Android app [KamVision-Showcase.apk](https://github.com/kamyab9k/KamVision/releases/download/v1.1.0/KamVision.v1.1.0.apk)
