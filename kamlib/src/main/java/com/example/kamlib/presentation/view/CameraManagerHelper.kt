...
class CameraManagerHelper(
    ...
    suspend fun openCamera(): CameraDevice? = withContext(Dispatchers.Main) {  // Use Main Dispatcher
        ...
        return@withContext suspendCoroutine { continuation ->
            try {
                ...
                }, Handler(Looper.getMainLooper()))  // Ensure Handler is associated with Main Looper
    ...
    suspend fun createCameraPreviewSession(
        ...
        previewSize: Size
    ): CameraCaptureSession? = withContext(Dispatchers.Main) {  // Use Main Dispatcher
        cameraDevice?.let { camera ->
            return@withContext suspendCoroutine { continuation ->
                try {
                    ...
                    camera.createCaptureSession(listOf(textureViewSurface), object : CameraCaptureSession.StateCallback() {
